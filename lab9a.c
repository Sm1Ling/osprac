...
char pathname[]="lab9a.c"; // The file name used to generate the key.
...
//
mybuf.sem_num = 0;
mybuf.sem_op = -5;// он будет пытаться сделать проверку но не сможет
mybuf.sem_flg = 0;
//былоб неплохо узнать, как узнавать текущее значение в семафоре...
